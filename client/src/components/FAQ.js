...
const FAQ = () => {
    ...
    const FAQs = [
        ...
        { question: 'How does RINS9 work?', answer: 'RINS9 is a water-souluble powder that absorbs into water instead of fat can first be absorbed sublingually.' },
        { question: 'What makes RINS9 work?', answer: 'We start with quality hemp which is turned into a nano-sonic water-soluble form, providing clean elevation without the need for alcohol' },
